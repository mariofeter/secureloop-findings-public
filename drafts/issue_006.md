...
`rkyv::from_bytes::<HashMap<String, String>, Error>(data)` triggers a reachable assertion (debug_assert violation reachable from safe API) on a crafted input. Reproducer
